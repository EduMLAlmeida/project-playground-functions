...
Segundo projeto desenvolvido como forma de avaliação durante o curso de Desenvolvimento Web que realizei na Trybe (https://www.betrybe.com/).

Avaliação referente à seção de introdução a JavaScript do módulo de fundamentos do Desenvolvimento Web.


## Objetivo

O objetivo desse projeto foi desenvolver funções, aplicando os conhecimentos adquiridos durante o bloco de Introdução à JavaScript e seguindo os requisitos especificados pela Trybe para o correto comportamento de cada uma delas.
...
- Criar códigos que usam estrutura condicional (if/else);
- Manipular arrays;
...
## Requisitos especificados pela Trybe
 ...
 - Os requisitos especificados pela Trybe para o correto comportamento de cada uma das funções para a realização do projeto e e aprovação na avaliação foram:
